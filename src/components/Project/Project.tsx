      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInY">
          <div className="project">
            ...
            <div className="body">
              {/* <h3>ROUTE OPTIMIZATION OF OPEN GRAPHS</h3> */}
              <h3>ANT COLONY OPTIMIZATION FOR OPEN GRAPHS</h3>
              <p>Applied ant colony optimization algorithm, in order to find the shortest path between two given points in open graphs like subway maps. </p>
            </div>
            <footer> <ul className="tech-list"> <li>AWS Lambda</li> <li>Python</li> <li>DynamoDB</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInY">
          <div className="project">
            ...
            <div className="body">
              <h3>SYSTEM IDENTIFICATION AND CONTROL OF NONLINEAR SYSTEMS </h3>
              <p>
              Applied particle swarm optimization for nonlinear system identification in orderto obtain a precise representation of the physical system and then simulation of control techniques before the real world implementation.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInY">
          <div className="project">
            ...
            <div className="body">
              <h3>FACE DETECTION WITH SVD</h3>
              <p>
              Applied Singular Value decomposition in order to facial recognition images.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInY">
          <div className="project">
            ...
            <div className="body">
              <h3>SOCIAL IMPACT PROJECT: HYDROPONIC PLANT ACCLIMATIZATION CHAMBER</h3>
              <p>I collaborated with a fellow schoolmate to develop a hydroponic-based plant acclimatization chamber project aimed at
                  variables such as light intensity, CO2 levels, and relative humidity within the system. Additionally, a camera system was
                  implemented to monitorthe size of plant stomata. Utilizing OpenCV, image processing techniques were employed to
                  assess the plants’ health status based on stomatal density. This project’s potential social impact is significant, as it is
                  slated for utilization in laboratories at CEPROBI, the National Polytechnic Institute’s research centerin Mexico.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>FASTApi</li>
